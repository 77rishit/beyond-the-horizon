  ...
  return (
    <ParallaxSection id="ocean" className="bg-ink" scrollLength="220vh">
      ...
      <ParallaxLayer speed={0.38} mouse={9} className="pointer-events-none absolute inset-0">
        <div className="animate-haze-slow absolute -top-[10%] left-[14%] h-[85%] w-[16vw] -rotate-6 bg-lagoon/12 blur-2xl" />
        <div className="animate-haze-alt absolute -top-[10%] left-[52%] h-[75%] w-[10vw] rotate-3 bg-lagoon/10 blur-2xl" />
      ...
      <ParallaxLayer speed={0.28} mouse={12} className="pointer-events-none absolute inset-0">
        <Whale className="animate-float-drift absolute left-[8%] top-[24%] w-[38vw] text-abyss-2/70" />
        <Whale className="animate-float-drift absolute right-[6%] top-[52%] w-[22vw] -scale-x-100 text-abyss-2/45 [animation-delay:-6s]" />
      </ParallaxLayer>
      ...
      >
        ...
        />
        <div className="absolute bottom-[6%] left-[30%] h-[16%] w-[8vw] rounded-t-full bg-coral/40 blur-[1px]" />
        <div className="absolute bottom-[4%] left-[62%] h-[12%] w-[6vw] rounded-t-full bg-coral/30 blur-[1px]" />
      </ParallaxLayer>
